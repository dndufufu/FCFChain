...
/**
 * REST controller for managing {@link cn.com.fcf.chain.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingTransaction -> {
                    if (transaction.getHash() != null) {
                        existingTransaction.setHash(transaction.getHash());
                    }
                    ...
                    if (transaction.getSignature() != null) {
                        existingTransaction.setSignature(transaction.getSignature());
                    }
