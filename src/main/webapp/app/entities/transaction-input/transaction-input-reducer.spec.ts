...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transaction-input.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONINPUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSACTIONINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSACTIONINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSACTIONINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONINPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSACTIONINPUT actions', async () => {
      const expectedActions = [
        {
