...
export const BlockDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="chainApp.block.delete.question">
        <Translate contentKey="chainApp.block.delete.question" interpolate={{ id: blockEntity.id }}>
