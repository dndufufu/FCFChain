...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './block.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BLOCK_LIST actions', async () => {
    ...
    it('dispatches FETCH_BLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BLOCK actions', async () => {
      const expectedActions = [
        {
