...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transaction-output.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONOUTPUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSACTIONOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSACTIONOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSACTIONOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONOUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSACTIONOUTPUT actions', async () => {
      const expectedActions = [
        {
