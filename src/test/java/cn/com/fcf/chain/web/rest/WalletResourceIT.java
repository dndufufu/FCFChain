...
class WalletResourceIT {
    ...
    public static Wallet createEntity(EntityManager em) {
        Wallet wallet = new Wallet().privateKey(DEFAULT_PRIVATE_KEY).publicKey(DEFAULT_PUBLIC_KEY);
        return wallet;
    }
    ...
    public static Wallet createUpdatedEntity(EntityManager em) {
        Wallet wallet = new Wallet().privateKey(UPDATED_PRIVATE_KEY).publicKey(UPDATED_PUBLIC_KEY);
        return wallet;
    }
    ...
    void putNewWallet() throws Exception {
        ...
        updatedWallet.privateKey(UPDATED_PRIVATE_KEY).publicKey(UPDATED_PUBLIC_KEY);
    ...
    void partialUpdateWalletWithPatch() throws Exception {
        ...
        partialUpdatedWallet.privateKey(UPDATED_PRIVATE_KEY).publicKey(UPDATED_PUBLIC_KEY);
